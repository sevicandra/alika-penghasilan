...
export const getAllKekuranganTukin = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const createKekuranganTukin = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const {
      bulan,
      tahun,
...
export const updateKekuranganTukin = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const hapusKekuranganTukin = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const id = parseInt(req.params.id);
    const data = await DataTukin.findByPk(id);
    if (!data || data.p22 === 0) {
